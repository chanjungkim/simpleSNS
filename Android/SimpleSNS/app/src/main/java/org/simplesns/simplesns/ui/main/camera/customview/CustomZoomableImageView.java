...
public class CustomZoomableImageView extends AppCompatImageView {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                // Only move if the ScaleGestureDetector isn't processing profile_a gesture.
            ...
            case MotionEvent.ACTION_POINTER_UP: {
                ...
                if (pointerId == mActivePointerId) {
                    // This was our active pointer going up. Choose profile_a new
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            Timber.d("mScaleFactor %s", mScaleFactor);
            Timber.d("pivotPointY " + pivotPointY + ", pivotPointX= " + pivotPointX);
